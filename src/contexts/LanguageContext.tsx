...
const translations: Record<Language, any> = {
  en: {
    ...
    howItWorks: {
      ...
      step1Title: 'Record Symptoms',
      step1Desc: 'Use our kiosk or app to record your symptoms and health concerns with our AI-powered analysis',
      step2Title: 'Book Consultation',
      step2Desc: 'Choose from available specialists and book your appointment at a time that works for you',
      step3Title: 'Get Treatment',
      step3Desc: 'Connect with your doctor via video call and receive personalized care and treatment plans',
  ...
  hi: {
    ...
    howItWorks: {
      ...
      step1Desc: 'हमारी AI-संचालित विश्लेषण के साथ अपने लक्षणों और स्वास्थ्य चिंताओं को दर्ज करने के लिए हमारे कियोस्क या ऐप का उपयोग करें',
      step2Title: 'परामर्श बुक करें',
      step2Desc: 'उपलब्ध विशेषज्ञों में से चुनें और अपनी सुविधा के अनुसार अपना अपॉइंटमेंट बुक करें',
      step3Title: 'उपचार प्राप्त करें',
      step3Desc: 'वीडियो कॉल के माध्यम से अपने डॉक्टर से जुड़ें और व्यक्तिगत देखभाल और उपचार योजनाएं प्राप्त करें',
  ...
  mr: {
    ...
    howItWorks: {
      ...
      subtitle: 'तीन सोप्या चरणांमध्ये सुरुवात करा',
      step1Title: 'लक्षणे नोंदवा',
      step1Desc: 'आमच्या AI-चालित विश्लेषणासह आपली लक्षणे आणि आरोग्य चिंता नोंदवण्यासाठी आमचे किओस्क किंवा अॅप वापरा',
      step2Title: 'सल्लामसलत बुक करा',
      step2Desc: 'उपलब्ध तज्ञांमधून निवडा आणि तुमच्या सोयीनुसार तुमची भेट बुक करा',
      step3Title: 'उपचार मिळवा',
      step3Desc: 'व्हिडिओ कॉलद्वारे तुमच्या डॉक्टरांशी संपर्क साधा आणि वैयक्तिकृत काळजी आणि उपचार योजना मिळवा',
