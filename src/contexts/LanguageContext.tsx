...
const translations: Record<Language, any> = {
  en: {
    ...
    pharmacy: {
      ...
      checkout: 'Checkout',
      reviewOrder: 'Review your order and complete checkout',
      ...
      selectFromPortal: 'Select from Portal Prescriptions',
      selectPrescription: 'Select a prescription',
      uploadFile: 'Upload prescription file (JPG, PNG, PDF)',
      placeOrder: 'Place Order',
      orderPlaced: 'Order placed!',
      orderFailed: 'Failed to place order',
      emptyCart: 'Empty cart',
      addItemsFirst: 'Please add items to cart before checkout',
      addressRequired: 'Address required',
      enterDeliveryAddress: 'Please enter delivery address',
      prescriptionNeeded: 'Please upload a prescription',
      selectPrescriptionFirst: 'Please select a prescription',
      invalidFileType: 'Invalid file type',
      uploadJPGPNGPDF: 'Please upload a JPG, PNG, or PDF file',
      fileTooLarge: 'File too large',
      fileSizeLimit: 'Please upload a file smaller than 5MB',
      stockLimit: 'Stock limit',
      cannotAddMore: 'Cannot add more than available stock',
      addedToCart: 'Added to cart'
    },
    orders: {
      title: 'My Orders',
      subtitle: 'View your pharmacy orders',
      orderId: 'Order ID',
      date: 'Date',
      amount: 'Amount',
      delivery: 'Delivery',
      ...
      ordersWillAppear: 'Your pharmacy orders will appear here',
  ...
  hi: {
    ...
    pharmacy: {
      title: 'फार्मेसी कियोस्क',
      subtitle: 'अपनी दवाएं ऑर्डर करें',
      cart: 'कार्ट',
      ...
      stock: 'स्टॉक',
      noMedicinesFound: 'कोई दवाएं नहीं मिलीं',
      checkout: 'चेकआउट',
      reviewOrder: 'अपने ऑर्डर की समीक्षा करें और चेकआउट पूरा करें',
      cartEmpty: 'आपकी कार्ट खाली है',
      each: 'प्रत्येक',
      totalAmount: 'कुल राशि',
      deliveryMethod: 'डिलीवरी विधि',
      pickup: 'फार्मेसी से पिकअप',
      ...
      selectFromPortal: 'पोर्टल नुस्खों से चुनें',
      selectPrescription: 'एक नुस्खा चुनें',
      uploadFile: 'नुस्खा फ़ाइल अपलोड करें (JPG, PNG, PDF)',
      placeOrder: 'ऑर्डर दें',
      orderPlaced: 'ऑर्डर दे दिया गया!',
      orderFailed: 'ऑर्डर देने में विफल',
      emptyCart: 'खाली कार्ट',
      addItemsFirst: 'कृपया चेकआउट से पहले कार्ट में आइटम जोड़ें',
      addressRequired: 'पता आवश्यक',
      enterDeliveryAddress: 'कृपया डिलीवरी पता दर्ज करें',
      prescriptionNeeded: 'कृपया एक नुस्खा अपलोड करें',
      selectPrescriptionFirst: 'कृपया एक नुस्खा चुनें',
      invalidFileType: 'अमान्य फ़ाइल प्रकार',
      uploadJPGPNGPDF: 'कृपया JPG, PNG, या PDF फ़ाइल अपलोड करें',
      fileTooLarge: 'फ़ाइल बहुत बड़ी है',
      fileSizeLimit: 'कृपया 5MB से छोटी फ़ाइल अपलोड करें',
      stockLimit: 'स्टॉक सीमा',
      cannotAddMore: 'उपलब्ध स्टॉक से अधिक नहीं जोड़ सकते',
      addedToCart: 'कार्ट में जोड़ा गया'
    },
    orders: {
      title: 'मेरे ऑर्डर',
      subtitle: 'अपने फार्मेसी ऑर्डर देखें',
      orderId: 'ऑर्डर आईडी',
      date: 'तारीख',
      amount: 'राशि',
      delivery: 'डिलीवरी',
      ...
      ordersWillAppear: 'आपके फार्मेसी ऑर्डर यहां दिखाई देंगे',
  ...
  mr: {
    ...
    pharmacy: {
      title: 'फार्मसी किओस्क',
      subtitle: 'तुमची औषधे ऑर्डर करा',
      cart: 'कार्ट',
      ...
      manufacturer: 'निर्माता',
      stock: 'स्टॉक',
      noMedicinesFound: 'औषधे आढळली नाहीत',
      checkout: 'चेकआउट',
      reviewOrder: 'तुमच्या ऑर्डरचे पुनरावलोकन करा आणि चेकआउट पूर्ण करा',
      cartEmpty: 'तुमची कार्ट रिकामी आहे',
      each: 'प्रत्येक',
      totalAmount: 'एकूण रक्कम',
      deliveryMethod: 'डिलिव्हरी पद्धत',
      pickup: 'फार्मसीमधून पिकअप',
      homeDelivery: 'होम डिलिव्हरी',
      deliveryAddress: 'डिलिव्हरी पत्ता',
      enterAddress: 'तुमचा डिलिव्हरी पत्ता प्रविष्ट करा...',
      pickupLocation: 'पिकअप स्थान',
      prescriptionRequired: 'प्रिस्क्रिप्शन आवश्यक',
      uploadPrescription: 'प्रिस्क्रिप्शन अपलोड करा',
      selectFromPortal: 'पोर्टल प्रिस्क्रिप्शनमधून निवडा',
      selectPrescription: 'प्रिस्क्रिप्शन निवडा',
      uploadFile: 'प्रिस्क्रिप्शन फाइल अपलोड करा (JPG, PNG, PDF)',
      placeOrder: 'ऑर्डर द्या',
      orderPlaced: 'ऑर्डर दिली!',
      orderFailed: 'ऑर्डर देण्यात अयशस्वी',
      emptyCart: 'रिकामी कार्ट',
      addItemsFirst: 'कृपया चेकआउट करण्यापूर्वी कार्टमध्ये वस्तू जोडा',
      addressRequired: 'पत्ता आवश्यक',
      enterDeliveryAddress: 'कृपया डिलिव्हरी पत्ता प्रविष्ट करा',
      prescriptionNeeded: 'कृपया प्रिस्क्रिप्शन अपलोड करा',
      selectPrescriptionFirst: 'कृपया प्रिस्क्रिप्शन निवडा',
      invalidFileType: 'अवैध फाइल प्रकार',
      uploadJPGPNGPDF: 'कृपया JPG, PNG किंवा PDF फाइल अपलोड करा',
      fileTooLarge: 'फाइल खूप मोठी आहे',
      fileSizeLimit: 'कृपया 5MB पेक्षा लहान फाइल अपलोड करा',
      stockLimit: 'स्टॉक मर्यादा',
      cannotAddMore: 'उपलब्ध स्टॉकपेक्षा जास्त जोडू शकत नाही',
      addedToCart: 'कार्टमध्ये जोडले'
    },
    orders: {
      title: 'माझे ऑर्डर',
      subtitle: 'तुमचे फार्मसी ऑर्डर पहा',
      orderId: 'ऑर्डर आयडी',
      date: 'तारीख',
      amount: 'रक्कम',
      delivery: 'डिलिव्हरी',
      ...
      ordersWillAppear: 'तुमचे फार्मसी ऑर्डर येथे दिसतील',
