...
DROP FUNCTION IF EXISTS public.add_doctor_info();
DROP FUNCTION IF EXISTS public.create_doctor_info_entry();
DROP FUNCTION IF EXISTS public.create_doctor_info_after_update();
